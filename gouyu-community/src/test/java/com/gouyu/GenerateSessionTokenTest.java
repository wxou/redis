...
@SpringBootTest
public class GenerateSessionTokenTest {

    public static void main(String[] args) {
        String loginUrl = "http://localhost:8081/member/login"; // 构域成员登录接口
        int count = 1000; // 生成 1000 个 token

        try (BufferedWriter writer = new BufferedWriter(new FileWriter("session-tokens.txt"))) {
            ...
            System.out.println("已生成 1000 个 token，保存在 session-tokens.txt");
